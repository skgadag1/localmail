...
<div id="id01" class="modal">
  <form class="modal-content" action="recover.php" method="post">
	...
	<label>Current Password</label></br>
      <input type="text" placeholder="Enter your password" name="uname" autofocus required/></br>
	  <label>New Password</label></br>
      <input type="text" placeholder="Enter new password" name="uname" required/></br>
	  <label>Confirm Password</label></br>
      <input type="text" placeholder="Re-enter new password" name="uname" required/></br>
